...
public class Main6Activity extends AppCompatActivity {
    ...
    public void checkLogin(View arg0) {
        ...
        new Main6Activity.AsyncLogin().execute(email,password);
    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://vampireorprincess.000webhostapp.com/register.inc.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("true"))
            {
                ...
                Toast.makeText(Main6Activity.this, "Problem Registering", Toast.LENGTH_LONG).show();

            } else if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {

                Toast.makeText(Main6Activity.this, "OOPs! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
